function initengahan(){
  ...
  afterComplete: function(){
    pesan5.innerHTML=vketik5 + " ><";setTimeout(aktipesan10,700);
  },}).go();
  }
  ...
  fthilang();ftganti=4;setTimeout(ftmuncul,300);
  new TypeIt("#pesan8", {
  strings: ["" + vketik8], startDelay: 1, speed: 52, cursor: true, waitUntilVisible: true, lifelike: true,
  afterComplete: function(){
    pesan8.innerHTML=vketik8;setTimeout(tombol,400);
  },}).go();
  }
  ...
  fthilang();ftganti=4;setTimeout(ftmuncul,300);
  new TypeIt("#pesan9", {
  strings: ["" + vketik9], startDelay: 1, speed: 52, cursor: true, waitUntilVisible: true, lifelike: true,
  afterComplete: function(){
    pesan9.innerHTML=vketik9;setTimeout(tombol,400);
  },}).go();
  }
  ...
  fthilang();ftganti=4;setTimeout(ftmuncul,300);
  new TypeIt("#pesan10", {
  strings: ["" + vketik10], startDelay: 1, speed: 52, cursor: true, waitUntilVisible: true, lifelike: true,
  afterComplete: function(){
    pesan10.innerHTML=vketik10;setTimeout(tombol,400);
  },}).go();
  }
